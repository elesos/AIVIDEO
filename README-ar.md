...
- [x] يدعم التكامل مع نماذج متعددة مثل **OpenAI** و**Moonshot** و**Azure** و**one-api** و**Qwen** و**Google Gemini** و**Ollama** و**DeepSeek** و**MiniMax** و**ERNIE** و**Pollinations** و**ModelScope** وغيرها
...
تريد تجربة AIVIDEO دون إعداد بيئة محلية؟ شغّله مباشرةً في Google Colab!
...
لاحظ أنك بحاجة لتنفيذ الأوامر التالية في `المجلد الجذر` لمشروع AIVIDEO
...
بعد تنزيل النموذج، فُكّ ضغطه وضع المجلد بالكامل في `.\AIVIDEO\models`،
وينبغي أن يبدو مسار الملف النهائي هكذا: `.\AIVIDEO\models\whisper-large-v3`
...
[issue 33](https://github.com/harry0703/AIVIDEO/issues/33)
...
[issue 54](https://github.com/harry0703/AIVIDEO/issues/54#issuecomment-2017842022)
...
- يمكنك إرسال [issue](https://github.com/harry0703/AIVIDEO/issues) أو
  [pull request](https://github.com/harry0703/AIVIDEO/pulls).
